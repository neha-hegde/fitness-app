...
public class ThridActivity4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_thrid4);
        ...
        switch(intvalue){
            ...
            case 10:
                ...
                break;
            case 11:
                setContentView(R.layout.activity_rlunge);
                break;
            case 12:
    ...
    private void starttimer()
    {
        ...
        countDownTimer= new CountDownTimer(MTimeLeft,1000) {
            ...
            public void onFinish() {
                ...
                if(newvalue <=7) {
                    Intent intent = new Intent(ThridActivity4.this, ThridActivity4.class);
